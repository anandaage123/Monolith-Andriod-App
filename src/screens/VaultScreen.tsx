...
// Files are stored in the app's private documentDirectory.
// We obscure the file extension to prevent easy access outside the vault.
...
const decryptFile = async (encryptedUri: string, pin: string, originalType?: 'image' | 'video', originalName?: string): Promise<string> => {
  // Restore original extension so Image/VideoView can recognise the format
  const ext = originalName?.split('.').pop() ?? (originalType === 'video' ? 'mp4' : 'jpg');
  const tmpUri = `${FileSystem.cacheDirectory}tmp_dec_${Date.now()}.${ext}`;
  await FileSystem.copyAsync({ from: encryptedUri, to: tmpUri });
  return tmpUri;
};
...
export default function VaultScreen() {
  ...
  const SwipeablePasswordRow = ({
    ...
    const renderRightActions = () => (
      <View style={[styles.swipeDeleteBg, { right: 0, position: 'relative', borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }]}>
    ...
    return (
      <View style={{ marginHorizontal: 8, marginBottom: 8 }}>
        <Swipeable renderRightActions={renderRightActions} overshootRight={false}>
          <TouchableOpacity onPress={onPress} style={[styles.passItem, { marginHorizontal: 0, marginBottom: 0 }]}>
  ...
  const styles = StyleSheet.create({
    ...
    logoTitle: { fontSize: scaleFontSize(32), fontWeight: '800', color: colors.text, marginTop: 16, letterSpacing: -0.5 },
    logoSub: { fontSize: scaleFontSize(13), color: colors.textVariant, letterSpacing: 1.5, fontWeight: '700' },
    ...
    wrongPinText: { color: colors.error, fontSize: scaleFontSize(14), fontWeight: '600', marginBottom: 20 },
    ...
    numBtnText: { fontSize: scaleFontSize(28), fontWeight: '600', color: colors.text },
    setupBanner: { marginBottom: 40, alignItems: 'center', paddingHorizontal: 40 },
    setupTitle: { fontSize: scaleFontSize(24), fontWeight: '800', color: colors.text, textAlign: 'center' },
    setupSub: { fontSize: scaleFontSize(14), color: colors.textVariant, textAlign: 'center', marginTop: 10, lineHeight: 20 },
    ...
    headerTitle: { fontSize: scaleFontSize(24), fontWeight: '800', color: colors.text },
    headerSub: { fontSize: scaleFontSize(12), color: colors.textVariant, marginTop: 2 },
    ...
    tabText: { fontSize: scaleFontSize(14), fontWeight: '700', color: colors.textVariant },
    ...
    searchInput: { flex: 1, fontSize: scaleFontSize(14), color: colors.text },
    ...
    statsBarText: { fontSize: scaleFontSize(12), color: colors.textVariant, fontWeight: '500' },
    ...
    tagText: { fontSize: scaleFontSize(13), fontWeight: '600', color: colors.textVariant, lineHeight: 16 },
    ...
    bulkCount: { flex: 1, fontSize: scaleFontSize(14), fontWeight: '700', color: colors.text },
    ...
    bulkBtnText: { fontSize: scaleFontSize(13), fontWeight: '600', color: colors.text },
    ...
    videoDuration: { fontSize: scaleFontSize(10), color: '#FFF', fontWeight: '700' },
    ...
    listItemInfo: { flex: 1 },
    listItemName: { fontSize: scaleFontSize(15), fontWeight: '700', color: colors.text, marginBottom: 2 },
    listItemMeta: { fontSize: scaleFontSize(12), color: colors.textVariant },
    ...
    microTagText: { fontSize: scaleFontSize(11), color: colors.primary, fontWeight: '600' },
    ...
    albumName: { fontSize: scaleFontSize(14), fontWeight: '700', color: colors.text },
    albumCount: { fontSize: scaleFontSize(12), color: colors.textVariant, marginTop: 2 },
    ...
    albumBadgeText: { color: '#FFF', fontSize: scaleFontSize(11), fontWeight: '700' },
    ...
    passInfo: { flex: 1 },
    passSite: { fontSize: scaleFontSize(16), fontWeight: '700', color: colors.text },
    passUser: { fontSize: scaleFontSize(13), color: colors.textVariant, marginTop: 2 },
    passRight: { alignItems: 'flex-end', gap: 4 },
    passEyeBtn: { padding: 4 },
    passRevealed: { fontSize: scaleFontSize(11), color: colors.textVariant, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace', maxWidth: 100 },
    ...
    strengthLabel: { fontSize: scaleFontSize(12), fontWeight: '700', minWidth: 70, textAlign: 'right' },
    ...
    emptyTitle: { fontSize: scaleFontSize(20), fontWeight: '800', color: colors.text, marginTop: 20 },
    emptySubtitle: { textAlign: 'center', color: colors.textVariant, marginTop: 8, lineHeight: 20, fontSize: scaleFontSize(14) },
    ...
    emptyActionBtnText: { color: '#FFF', fontWeight: '700', fontSize: scaleFontSize(14) },
    ...
    modalTitle: { fontSize: scaleFontSize(20), fontWeight: '800', color: colors.text, letterSpacing: -0.3 },
    compactModal: { backgroundColor: colors.surface, margin: 24, borderRadius: 24, padding: 24, ...Shadows.soft },
    settingSection: { fontSize: scaleFontSize(11), fontWeight: '700', color: colors.textVariant, letterSpacing: 1.2, marginTop: 16, marginBottom: 4, paddingHorizontal: 4 },
    settingRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, gap: 14 },
    settingIcon: { width: 36, height: 36, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
    settingLabel: { flex: 1, fontSize: scaleFontSize(16), fontWeight: '600', color: colors.text },
    settingSubLabel: { fontSize: scaleFontSize(12), color: colors.textVariant, marginTop: 2 },
    ...
    autoLockChipText: { fontSize: scaleFontSize(13), fontWeight: '600', color: colors.textVariant },
    ...
    statLabel: { fontSize: scaleFontSize(12), color: colors.textVariant, fontWeight: '600' },
    statValue: { fontSize: scaleFontSize(12), fontWeight: '800', color: colors.primary },
    ...
    passModalTitle: { fontSize: scaleFontSize(20), fontWeight: '800', color: colors.text, marginBottom: 20 },
    inputLabel: { fontSize: scaleFontSize(12), fontWeight: '700', color: colors.textVariant, marginBottom: 6, letterSpacing: 0.5 },
    input: { height: 50, backgroundColor: colors.background, borderRadius: 14, paddingHorizontal: 16, marginBottom: 14, color: colors.text, fontSize: scaleFontSize(15), borderWidth: 1, borderColor: colors.outlineVariant },
    ...
    cancelBtnText: { fontWeight: '700', color: colors.textVariant, fontSize: scaleFontSize(15) },
    saveBtnText: { fontWeight: '700', color: '#FFF', fontSize: scaleFontSize(15) },
    detailRow: { paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.outlineVariant },
    detailLabel: { fontSize: scaleFontSize(11), fontWeight: '700', color: colors.textVariant, letterSpacing: 0.8, marginBottom: 4 },
    detailValue: { fontSize: scaleFontSize(15), color: colors.text, fontWeight: '500' },
    ...
    detailBtnText: { fontSize: scaleFontSize(15), fontWeight: '700', color: colors.text },
    ...
    viewerCounterText: { color: '#FFF', fontSize: scaleFontSize(13), fontWeight: '700' },
    ...
    viewerTagText: { fontSize: scaleFontSize(12), color: '#FFF', fontWeight: '600' },
    ...
    addTagBtnText: { fontSize: scaleFontSize(12), color: 'rgba(255,255,255,0.8)', fontWeight: '600' },
    ...
    viewerBtnText: { color: 'rgba(255,255,255,0.8)', fontSize: scaleFontSize(12), fontWeight: '600' },
    ...
    tagManagerName: { fontSize: scaleFontSize(15), fontWeight: '700', color: colors.text },
    tagManagerCount: { fontSize: scaleFontSize(12), color: colors.textVariant, marginTop: 2 },
  ...
  const handleRestoreWithPin = async () => {
    ...
    if (restorePin === savedPin) {
      ...
      const attempts = restoreAttempts + 1;
      setRestoreAttempts(attempts);
      hapticImpact('Heavy');
      if (attempts >= 3) {
        setRestorePinError('Max attempts reached. Resetting vault data...');
        setTimeout(() => handleFreshStart(), 2000);
      } else {
        setRestorePinError(`Incorrect PIN — ${3 - attempts} attempt(s) remaining.`);
      }
    }
  };
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <View style={[StyleSheet.absoluteFillObject, { backgroundColor: colors.surfaceContainer }]}>
                      ...
                      {item.type === 'video' && (
                        <View style={[StyleSheet.absoluteFillObject, { alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.2)' }]}>
                          <Ionicons name="play" size={gridItemSize * 0.35} color="rgba(255,255,255,0.8)" />
                        </View>
                      )}
                      {item.encrypted && (
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <View style={[styles.listThumb, { backgroundColor: colors.surfaceContainer, overflow: 'hidden' }]}>
                      <Image source={{ uri: item.uri }} style={StyleSheet.absoluteFillObject} />
                      {item.type === 'video' && (
                        <View style={[StyleSheet.absoluteFillObject, { alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.2)' }]}>
